...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="py-16 md:py-24 bg-secondary-background relative"
    >
            ...
            <div className="w-full md:w-2/3">
              <div className="reveal-fade space-y-6 md:space-y-8 text-lg md:text-2xl font-light text-black/80 leading-relaxed mb-12 md:mb-16">
                <p>
                  ...
                  passionate about building modern web applications. I combine
                  clean UI design and robust backend engineering to create fast,
                  scalable, and user-focused digital experiences.
                </p>
                <p className="text-base md:text-lg text-black/60">
                  My work focuses on technologies like React, Next.js, Node.js,
                  and Django, where I build responsive interfaces, scalable
                  APIs, and high-performance applications from concept to
                  deployment.
                </p>
