...
export default function Contact() {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        formData.append("entry.625667604", (form.elements.namedItem("name") as HTMLInputElement).value);
        formData.append("entry.1665157167", (form.elements.namedItem("email") as HTMLInputElement).value);
        formData.append("entry.1077078572", (form.elements.namedItem("message") as HTMLTextAreaElement).value);
        ...
        try {
            ...
            // Since 'no-cors' doesn't return response status, we assume success if no error is thrown
            setLoading(false);
            setSuccess(true);
            ...
            <div className="grid md:grid-cols-2 gap-12 md:gap-24">
                <div>
                    ...
                    <p className="text-black/70 text-lg mb-8 leading-relaxed">
                        Have a project in mind? Looking for a partner who cares about design and performance as much as you do? Drop me a line.
                    </p>

                    <div className="space-y-4">
                        <a href="mailto:althafdev01@gmail.com" className="flex items-center gap-4 text-xl font-bold hover:text-accent transition-colors">
