      ...
      <div className="container-custom mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10">
        <div ref={textRef} className="order-2 md:order-1 relative">
          ...
          <div className="relative z-10">
            ...
            <p className="hero-text-element text-lg md:text-xl text-black/70 max-2xl mb-10 font-medium leading-relaxed">
              Full-stack developer creating modern applications with React,
              Next.js, Node.js, Django, and clean API architecture.
            </p>
            <div className="hero-text-element flex flex-wrap gap-4">
              ...
              <Link href="#contact">
                <Button
                  variant="outline"
                  className="bg-white/50 backdrop-blur-sm hover:bg-white hover:text-black"
                >
                  Contact Me
                </Button>
              </Link>
